...
struct AddOptionsT : public flatbuffers::NativeTable {
  ...
  struct AddOptions FLATBUFFERS_FINAL_CLASS :
...
struct SubOptionsT : public flatbuffers::NativeTable {
  ...
  struct SubOptions FLATBUFFERS_FINAL_CLASS :
  private flatbuffers::Table {
...
BatchMatMulOptionsBuilder builder_(_fbb);
    ...
    struct CumsumOptions FLATBUFFERS_FINAL_CLASS :
    private flatbuffers::Table {
    ...
    struct OperatorCode FLATBUFFERS_FINAL_CLASS :
    private flatbuffers::Table {
...
struct TensorMap FLATBUFFERS_FINAL_CLASS :
private flatbuffers::Table {
...
struct Model FLATBUFFERS_FINAL_CLASS :
private flatbuffers::Table {
